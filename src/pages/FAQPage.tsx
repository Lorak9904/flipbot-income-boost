...
const FAQPage = () => {
  ...
  return (
    <div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto text-center">
          <h1 className="font-bold mb-6">
            Frequently Asked <span className="text-flipit-teal">Questions</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Find answers to common questions about FlipIt AI and how it can help you earn extra income through resale arbitrage.
          </p>
        </div>
      </section>
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {openItem === index ? 
                      <ChevronUp className="h-5 w-5 text-flipit-teal" /> : 
                      <ChevronDown className="h-5 w-5 text-flipit-teal" />
                    }
                  </button>
                  {openItem === index && (
      ...
      <section className="py-16 md:py-20 bg-flipit-teal/5">
        <div className="container mx-auto text-center">
          ...
          <Button asChild className="secondary-btn">
            <a href="mailto:support@flipitai.com">Contact Us</a>
          </Button>
        </div>
      </section>
