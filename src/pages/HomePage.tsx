...
import { ArrowRight, Search, MessageSquare, DollarSign, Flame } from 'lucide-react';
    ...
    <div className="bg-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <h1 className="font-bold text-4xl md:text-5xl lg:text-6xl leading-tight text-white">
                Turn Online Finds into <span className="gradient-text">Real Profits</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Button asChild variant="outline" className="border-orange-500/50 text-orange-400 hover:bg-orange-500/10">
                  <Link to="/how-it-works">See how it works <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
              </div>
            </div>
            <div className="relative flex justify-center">
              <div className="glass-card p-6 rounded-2xl shadow-xl max-w-md animate-fade-in border border-slate-700/50">
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800 rounded-lg p-3 max-w-[80%] text-gray-300">
                    I want to make some extra money. Can you help?
                  </div>
                  <div className="bg-orange-500/20 rounded-lg p-3 ml-auto max-w-[80%] text-orange-400">
      ...
      <section className="section bg-slate-800/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">How FlipIt Makes You Money</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-6 rounded-xl shadow-xl hover-lift">
              <div className="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center mb-4">
                <Search className="h-6 w-6 text-orange-400" />
              </div>
              <h3 className="text-xl font-semibold mb-2 text-white">Smart Marketplace Scanner</h3>
            ...
            <div className="glass-card p-6 rounded-xl shadow-xl hover-lift">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Automated Negotiations</h3>
              <p className="text-gray-400">
            ...
            <div className="glass-card p-6 rounded-xl shadow-xl hover-lift">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Profit Maximizer</h3>
              <p className="text-gray-400">
      ...
      <section className="section bg-slate-900">
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto glass-card p-8 rounded-2xl shadow-xl">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-full bg-slate-700 overflow-hidden border border-slate-600">
                <img 
              ...
              <div>
                <h4 className="font-semibold text-lg text-white">Marta K.</h4>
