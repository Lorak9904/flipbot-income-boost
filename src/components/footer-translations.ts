...
export const footerTranslations: Translations = {
  en: {
    ...
    joinWaitlistDesc: 'Be the first to know when FlipIt launches.',
    joinNow: 'Join Now',
  ...
  pl: {
    ...
    joinWaitlistTitle: 'Dołącz do Listy Oczekujących',
    joinWaitlistDesc: 'Bądź pierwszym, który dowie się o uruchomieniu FlipIt.',
