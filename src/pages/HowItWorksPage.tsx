      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto text-center">
          <h1 className="font-bold mb-6">
            How FlipIt AI <span className="text-flipit-teal">Works</span>
          </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="col-span-1 flex flex-col items-center md:items-start">
                <div className="w-16 h-16 bg-flipit-teal/10 rounded-full flex items-center justify-center mb-4">
                  <Search className="h-8 w-8 text-flipit-teal" />
                </div>
                <h3 className="text-2xl font-semibold mb-2">Discovery</h3>
              </div>
              <div className="col-span-2">
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h4 className="text-lg font-semibold mb-4">FlipIt AI scans local marketplaces to find undervalued items</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-flipit-teal mt-0.5 flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="col-span-1 flex flex-col items-center md:items-start">
                <div className="w-16 h-16 bg-flipit-teal/10 rounded-full flex items-center justify-center mb-4">
                  <MessageSquare className="h-8 w-8 text-flipit-teal" />
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  ...
                  <div className="mt-6 p-4 rounded-lg bg-gray-100">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="w-8 h-8 bg-flipit-teal rounded-full flex items-center justify-center text-white font-bold text-xs">
                        FB
                      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="col-span-1 flex flex-col items-center md:items-start">
                <div className="w-16 h-16 bg-flipit-teal/10 rounded-full flex items-center justify-center mb-4">
                  <Image className="h-8 w-8 text-flipit-teal" />
                </div>
                  ...
                  <div className="mt-6 bg-white rounded-lg p-4 border border-gray-100 flex flex-col gap-4">
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-flipit-orange font-medium mb-2">560 PLN</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              <div className="col-span-1 flex flex-col items-center md:items-start">
                <div className="w-16 h-16 bg-flipit-teal/10 rounded-full flex items-center justify-center mb-4">
                  <DollarSign className="h-8 w-8 text-flipit-teal" />
                </div>
                  ...
                  <div className="mt-6 bg-white rounded-lg p-4 border border-gray-100">
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex justify-between font-semibold">
                        <p>Your Profit:</p>
                        <p className="text-flipit-orange">+340 PLN</p>
                      </div>
                    </div>
                  </div>
                </div>
