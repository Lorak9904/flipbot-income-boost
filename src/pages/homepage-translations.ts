...
export const homePageTranslations: Translations = {
  en: {
    ...
    feature1Desc: 'Publish on OLX, Vinted, Facebook Marketplace, eBay, Allegro, and Etsy from one workflow — no manual reposting.',
  ...
  pl: {
    ...
    feature1Desc: 'Publikuj na OLX, Vinted, Facebook Marketplace, eBay, Allegro i Etsy z jednego miejsca — bez ręcznego przepisywania.',
