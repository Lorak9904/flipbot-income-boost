...
export const PricingToggle = ({ 
  ...
  return (
    <div className="flex w-full max-w-xs flex-col items-center justify-center gap-2">
      ...
      >
        <div
          className={`absolute left-1 top-1 h-11 w-[calc(50%-4px)] rounded-md bg-cyan-500 transition-transform duration-200 motion-reduce:transition-none ${
        ...
        <div className="relative z-10 grid grid-cols-2 gap-2">
          <button
            ...
            className="flex min-h-11 items-center justify-center rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950"
          >
