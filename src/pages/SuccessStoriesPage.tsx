...
const SuccessStoriesPage = () => {
  return (
    <div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto text-center">
          <h1 className="font-bold mb-6">
            Success <span className="text-flipit-teal">Stories</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Real people making real profits with FlipIt AI.
          ...
          <div className="grid grid-cols-1 gap-12">
            {testimonials.map((testimonial) => (
              ...
              >
                ...
                <div className="bg-flipit-orange/10 p-4 rounded-lg inline-block">
      ...
      {/* Quote Section */}
      <section className="py-16 md:py-20 bg-flipit-teal/10">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-8">
              "FlipIt AI has helped users generate over 15,000 PLN in collective profits during our beta testing phase."
            </h2>
