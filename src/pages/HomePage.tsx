...
const HomePage = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="py-16 md:py-24 bg-gradient-immersive text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <h1 className="font-bold text-4xl md:text-5xl lg:text-6xl leading-tight">
                Turn Online Finds into <span className="text-flipit-teal">Real Profits</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-300 max-w-lg">
                FlipIt AI scans marketplaces, finds undervalued items, and helps you resell them for profit — all on autopilot.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button asChild className="cta-btn">
                  <Link to="/get-started">Start flipping today</Link>
                </Button>
                <Button asChild variant="outline" className="border-flipit-teal text-flipit-teal hover:bg-flipit-teal/5">
                  <Link to="/how-it-works">See how it works <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
              </div>
            </div>
            <div className="relative flex justify-center">
              <div className="bg-flipit-dark/60 backdrop-blur-sm p-6 rounded-2xl shadow-lg max-w-md animate-fade-in border border-white/10">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="font-semibold">FlipIt Assistant</h4>
                  <div className="h-3 w-3 bg-green-500 rounded-full"></div>
                </div>
                <div className="space-y-4">
                  <div className="bg-flipit-dark/80 rounded-lg p-3 max-w-[80%]">
                    I want to make some extra money. Can you help?
                  </div>
                  <div className="bg-flipit-teal/10 rounded-lg p-3 ml-auto max-w-[80%] text-flipit-teal">
      ...
      {/* Features Preview */}
      <section className="section bg-flipit-dark text-white">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-flipit-dark-charcoal/80 backdrop-blur-sm p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-white/10">
              <div className="w-12 h-12 bg-flipit-teal/10 rounded-lg flex items-center justify-center mb-4">
                <Search className="h-6 w-6 text-flipit-teal" />
              </div>
            ...
            <div className="bg-flipit-dark-charcoal/80 backdrop-blur-sm p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-white/10">
              <div className="w-12 h-12 bg-flipit-teal/10 rounded-lg flex items-center justify-center mb-4">
                <MessageSquare className="h-6 w-6 text-flipit-teal" />
              </div>
            ...
            <div className="bg-flipit-dark-charcoal/80 backdrop-blur-sm p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-white/10">
              <div className="w-12 h-12 bg-flipit-teal/10 rounded-lg flex items-center justify-center mb-4">
                <DollarSign className="h-6 w-6 text-flipit-teal" />
              </div>
      ...
      {/* Testimonial Preview */}
      <section className="section bg-flipit-charcoal text-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto bg-flipit-dark-charcoal/60 backdrop-blur-sm p-8 rounded-2xl shadow-md border border-white/10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-300">Warsaw, Poland</p>
              </div>
            </div>
            ...
            <blockquote className="text-lg text-gray-200 mb-6">
            ...
            <p className="text-flipit-orange font-medium">
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-24 bg-gradient-immersive">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ready to Start Making Money?</h2>
