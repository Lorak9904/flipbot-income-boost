...
export const connectAccountsTranslations: Translations = {
  en: {
    // Page metadata
    ...
    toastVintedVerificationTitle: 'Vinted verification required',
    toastVintedVerificationDescription: "Complete Vinted's security check in your browser, then update the connection.",
    ...
    toastVintedDisconnectedDescription: 'Stored cookies removed.',
    toastVintedDisconnectFailedTitle: 'Disconnect Failed',
    toastAuthRequiredTitle: 'Authentication Required',
    toastAuthRequiredDescription: 'Please log in to add items',
  },
  pl: {
    // Page metadata
    ...
    toastVintedVerificationTitle: 'Vinted wymaga weryfikacji',
    toastVintedVerificationDescription: 'Przejdź kontrolę bezpieczeństwa w Vinted, a następnie zaktualizuj połączenie.',
    ...
    toastVintedDisconnectedDescription: 'Zapisane ciasteczka zostały usunięte.',
    toastVintedDisconnectFailedTitle: 'Rozłączanie nie powiodło się',
    toastAuthRequiredTitle: 'Wymagane uwierzytelnienie',
    toastAuthRequiredDescription: 'Zaloguj się, aby dodawać przedmioty',
  },
};
