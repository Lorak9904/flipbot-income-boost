...
export function StatCard({
  ...
  return (
    <Card className="group relative overflow-hidden rounded-2xl border-white/5 bg-gradient-to-br from-[#0f1118]/95 via-[#141824]/90 to-[#1a1f2e]/85 ring-1 ring-white/5 backdrop-blur-xl transition-all duration-500 hover:scale-[1.02] hover:border-white/70 hover:ring-white/70 hover:shadow-[0_0_25px_-12px_rgba(34,211,238,0.35)]">
...
export function StatCardSkeleton() {
  return (
    <Card className="relative overflow-hidden rounded-2xl border-white/5 bg-[#0f1118]/80 ring-1 ring-white/5 backdrop-blur-xl">
