...
const pageDescription = 'Read FlipIt\'s terms for our marketplace automation platform: AI crosslisting that removes the hassle of writing descriptions, choosing categories, and pricing across OLX, Vinted, Facebook Marketplace, eBay, Allegro, and Etsy.';
const keywords = [
