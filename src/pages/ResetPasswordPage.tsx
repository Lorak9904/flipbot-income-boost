...
const ResetPasswordPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-neutral-950 text-white">
      <SEOHead
        title={language === 'pl' ? 'Ustaw nowe hasło FlipIt' : 'Set a new FlipIt password'}
        description={language === 'pl' ? 'Ustaw nowe hasło do swojego konta FlipIt.' : 'Set a new password for your FlipIt account.'}
        language={language}
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center gap-10 px-6 py-16 lg:flex-row lg:items-center lg:justify-center">
        ...
        >
          ...
          {success && (
            <div role="alert" className="mb-4 rounded-lg bg-emerald-500/10 p-3 text-sm text-emerald-400 ring-1 ring-emerald-400/50">
